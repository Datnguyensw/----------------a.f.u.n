...
(function () {
    ...
    var divtime = document.getElementById("afun-time-play");
    function m() {
        return function () {
        }
    }
    ...
    t.d = function (a, c, d) {
        ...
        e.Y || (e.disabled = l, e.Y = function (c) {
            if (!e.disabled) {
                ...
                var d = e.D[c.type];
                if (d)
                    for (var d = d.slice(0), j = 0, n = d.length; j < n && !c.xc() ; j++)
                        d[j].call(a, c)
            }
        });
    ...
    t.h.pd = function (a, c) {
        ...
        a = t.h.copy(a);
        for (d in c)
            v.call(c, d) && (e = a[d], g = c[d], a[d] = t.h.Ta(e) && t.h.Ta(g) ? t.h.pd(e, g) : c[d]);
        return a
    };
    t.h.copy = function (a) {
        return t.h.A({}, a)
    ...
    t.ha.Wa = function (a, c) {
        ...
        a = t.h.copy(a);
        for (d in c)
            c.hasOwnProperty(d) && (e = a[d], g = c[d], a[d] = t.h.Ta(e) && t.h.Ta(g) ? t.ha.Wa(e, g) : c[d]);
        return a
    };
    t.a = t.ra.extend({
        i: function (a, c, d) {
    ...
    function F(a, c, d, e) {
        if (d !== b)
            return a.b.style[c] = -1 !== ("" + d).indexOf("%") || -1 !== ("" + d).indexOf("px") ? d : "auto" === d ? "" : d + "px", e || a.m("resize"), a;
        if (!a.b)
            return 0;
        d = a.b.style[c];
        e = d.indexOf("px");
    ...
    s.e = function (a, c) {
        ...
        c = t.h.A({ role: "slider", "aria-valuenow": 0, "aria-valuemin": 0, "aria-valuemax": 100, "id": "afun_video_id", tabIndex: 0 }, c);
    ...
    s.xa = function () {
        ...
        this.options().title && a.ka().appendChild(t.e("li", { className: "vjs-menu-title", innerHTML: t.ba(this.options().title), fe: -1 }));
    ...
    for (var K = 0; K < t.F.Sa.length; K++)
        t.F[t.F.Sa[K]] = K, t.F.prototype[t.F.Sa[K]] = K;
    var L, M, N, O;
    ...
    s.volume = function (a) {
        if (a !== b)
            return a = Math.max(0, Math.min(1, parseFloat(a))), this.G.volume = a, S(this, "setVolume", a), t.Zd(a), this;
    ...
    s.exitFullscreen = function () {
        ...
        if (a)
            ...
            this.k.Ea() ? S(this, "exitFullScreen") : (this.Db(), this.m("fullscreenchange"));
        return this
    };
    s.pc = function () {
        this.Cd = f;
    ...
    function T(a, c) {
        ...
        d ? d.k === a.fb ? a.src(d.source) : P(a, d.k, d.source) : (a.error({ code: 4, message: a.s(a.options().notSupportedMessage) }), a.Ga())
    }
    s.load = function () {
        S(this, "load");
        return this
    ...
    t.Ja = t.a.extend();
    t.Ja.prototype.l = { qe: "play", children: { playToggle: {}, currentTimeDisplay: {}, timeDivider: {}, durationDisplay: {}, remainingTimeDisplay: {}, liveDisplay: {}, progressControl: {}, fullscreenToggle: {}, volumeControl: {}, muteToggle: {}, playbackRateMenuButton: {} } };
    ...
    t.ib.prototype.e = function () {
        ...
        this.v = t.e("div", { className: "vjs-current-time-display", id: "afun-time-play", innerHTML: '<span class="vjs-control-text">Current Time </span>0:00', "aria-live": "off" });
        a.appendChild(this.v);
        return a
    };
    t.ib.prototype.ga = function () {
        ...
        var time = t.za(a, this.c.duration());
        document.getElementById("lemon-time-play").innerHTML = time;
    };
    t.jb = t.a.extend({
        i: function (a, c) {
            t.a.call(this, a, c);
    ...
    s.xa = function () {
        ...
        if (c)
            for (var d = c.length - 1; 0 <= d; d--)
                a.R(new t.ob(this.j(), { rate: c[d] + "x" }));
        return a
    };
    s.pa = function () {
    ...
    t.g = t.u.extend({
        i: function (a, c, d) {
            ...
            for (d = t.g.lb.length - 1; 0 <= d; d--)
                t.d(this.b, t.g.lb[d], t.bind(this, this.vd));
    ...
    s.e = function () {
        ...
        if (!c || this.o.movingMediaElementInDOM === l)
            c ? (d = c.cloneNode(l), t.g.Cb(c), c = d, a.P = k) : (c = t.e("video"), t.Ic(c, t.h.A(a.ge || {}, { id: a.id() + "_html5_api", "class": "vjs-tech" }))), c.player = a, t.Hb(c, a.w());
        ...
        if (0 < this.ca.length) {
            ...
            if (this.Pb === b || a < this.Pb || this.Xa <= a) {
                ...
                for (; ;) {
                    q = c[w];
                    if (q.ya <= a)
                        e = Math.max(e, q.ya), q.Oa && (q.Oa = l);
                    else if (a < q.startTime) {
                        if (d = Math.min(d, q.startTime), q.Oa && (q.Oa = l), !g)
                            break
                    } else
    ...
    s.xa = function () {
        ...
        a = this.Ba;
        a === b && (a = new t.ia(this.c), a.ka().appendChild(t.e("li", { className: "vjs-menu-title", innerHTML: t.ba(this.H), fe: -1 })));
        if (g) {
            e = g.ca;
